...
/**
 * Provider for ArtifactoryAuthentication objects. The ArtifactoryAuthentication
 * should be created ahead of time with this module simply handing it out
 * to downstream objects for injection.
 */
public class ArtifactoryAuthenticationProvider implements Provider<ArtifactoryAuthentication> {

    private final ArtifactoryAuthentication creds;

    @Inject
    public ArtifactoryAuthenticationProvider(final ArtifactoryAuthentication creds) {
        this.creds = creds;
    }
